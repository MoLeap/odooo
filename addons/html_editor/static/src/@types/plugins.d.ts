declare module "plugins" {
    ...
    import { toolbar_groups, toolbar_items, toolbar_namespaces, toolbar_namespace_extra_group_providers, ToolbarShared } from "@html_editor/main/toolbar/toolbar_plugin";
