...
class ResConfigSettings(models.TransientModel):
    ...
    country_code = fields.Char(related="company_id.country_code", string="Company Country Code", readonly=True)
    country_group_codes = fields.Json(related="company_id.country_id.country_group_codes")
