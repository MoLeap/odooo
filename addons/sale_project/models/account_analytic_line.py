        ...
        for line in self:
            if line.amount >= 0 and line.unit_amount >= 0:
                ...
                if line.category == 'picking_entry':
                    ...
                    line.billable_type = '14_other_costs'

    @api.depends('billable_type')
    def _compute_project_category_report(self):
        for line in self:
            if line.billable_type in ['01_revenues_fixed', '03_timesheet_revenues', '05_revenues_milestones',
                                      '07_revenues_manual', '10_service_revenues']:
                line.category_report = 'invoice'
            elif line.billable_type in ['02_billable_fixed', '04_billable_time', '06_billable_milestones',
                                        '08_billable_manual', '09_non_billable']:
