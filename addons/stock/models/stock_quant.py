...
class StockQuant(models.Model):
    _name = 'stock.quant'
    _description = 'Quant'
    _explication = "The actual, current inventory on hand. A quant tracks how much of a specific product is currently sitting in a specific location (down to the lot/serial number or package)."
