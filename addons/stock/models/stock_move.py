...
class StockMove(models.Model):
    ...
    _explication = "Represents a request or a completed action to move a specific quantity of a product from a source location to a destination location. These are the lines that make up a stock.picking."
    _order = 'sequence, id'
    _rec_name = 'reference'
