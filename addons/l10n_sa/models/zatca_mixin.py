...
class ZatcaMixin(models.AbstractModel):
    ...
    def _compute_qr_code_str(self):
        phase_1_records = self.filtered(lambda rec: rec._l10n_sa_is_phase_1_applicable() and not rec._l10n_sa_is_phase_2_applicable())
        ...
        (self - (phase_1_records | phase_2_records)).l10n_sa_qr_code_str = False
