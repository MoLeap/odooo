...
class SetVariantRibbonAction extends BuilderAction {
    ...
    isApplied({ editingElement, value }) {
        ...
        const match =
            !ribbonId ||
            !Object.prototype.hasOwnProperty.call(this.ribbonOptions.getRibbonsObject(), ribbonId)
                ? ""
                : ribbonId;
        return match === value;
    }
...
class CreateVariantRibbonAction extends BuilderAction {
    ...
    apply({ editingElement }) {
        const productVariantId = editingElement
            .querySelector('[data-oe-model="product.product"]')
            .getAttribute("data-oe-id");
        this.ribbonOptions.setProductVariantID(parseInt(productVariantId));
...
registry
    ...
    .add(ProductVariantRibbonOptionPlugin.id, ProductVariantRibbonOptionPlugin);
