...
import { PRODUCT_VARIANT_OPTION_SELECTOR } from "./product_variant_option";
...
export class ProductVariantOptionPlugin extends Plugin {
    ...
    resources = {
        ...
        container_title: {
            selector: PRODUCT_VARIANT_OPTION_SELECTOR,
        ...
        builder_options_render_context: {
            productVariantOptionSelector: PRODUCT_VARIANT_OPTION_SELECTOR,
        },
    };
}
