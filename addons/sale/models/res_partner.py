...
class ResPartner(models.Model):
    ...
    _explication = "In the Sales context, partners represent Customers. Use this to track sales history, credit limits, and pricing lists specific to the customer's relationship with the company."
