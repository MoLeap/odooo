...
class SaleOrder(models.Model):
    ...
    def _get_advantages(self):
        ...
        for line in self.order_line:
            # Add coupon to special type lines. Calculate base_line without any discount.
            kwargs = {"special_type": "coupon"} if line.coupon_id else {"discount": 0}
            base_line = line._prepare_base_line_for_taxes_computation(**kwargs)
