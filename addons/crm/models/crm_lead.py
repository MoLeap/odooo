...
class CrmLead(models.Model):
    _name = 'crm.lead'
    _description = "Lead"
    _explication = "Represents a potential sales opportunity or lead. Use this to track interactions, estimated revenue, and the progress of a potential sale through different stages of your sales pipeline."
