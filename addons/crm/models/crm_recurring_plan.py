...
class CrmRecurringPlan(models.Model):
    ...
    _explication = "Defines billing intervals for recurring revenues (e.g., Monthly, Yearly). Applied to leads/opportunities to estimate future subscription income."
    _order = "sequence"
