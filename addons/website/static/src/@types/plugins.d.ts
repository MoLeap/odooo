declare module "plugins" {
    ...
    import { CustomizeWebsiteShared, website_color_updated_handlers } from "@website/builder/plugins/customize_website_plugin";
    ...
    export interface WebsiteResourcesList {
        ...
        website_color_updated_handlers: website_color_updated_handlers;
