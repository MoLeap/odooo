...
function fillInputField(selector, value) {
    return [
        {
            content: `Fill the input field with the value ${value}`,
            trigger: `${selector}`,
            run: `edit ${value}`,
        },
    ];
...
function checkField(value) {
    return [
        {
            content: `Verify that the field is correctly set to '${value}'`,
...
registerWebsitePreviewTour(
    ...
    () => [
        {
            content: "Select the 'Confirm Password' field to continue",
...
registerWebsitePreviewTour("website_signup_custom_form_submit", {}, () => [
    {
        content: "Click the 'Don't have an account?' link",
