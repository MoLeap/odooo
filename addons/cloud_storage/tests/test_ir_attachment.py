...
from odoo.addons.cloud_storage.models.ir_attachment import IrAttachment
...
class TestIrAttachment(TransactionCase):
    ...
    def test_post_add_create_preserves_mimetype(self):
        ...
        self.patch(IrAttachment, '_generate_cloud_storage_url', _generate_cloud_storage_url)
