...
class HolidaysAllocation(models.Model):
    ...
    def _get_accrual_plan_level_work_entry_prorata(self, level, start_period, start_date, end_period, end_date):
        ...
        start_dt = tz.localize(datetime.combine(start_date, datetime_min_time))
        end_dt = tz.localize(datetime.combine(end_date, datetime_min_time))
        ...
        for attendance in attendances:
            worked_hours = attendance._get_worked_hours_in_range(start_utc, end_utc)
