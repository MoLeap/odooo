...
class HrAttendance(models.Model):
    ...
    overtime_hours = fields.Float(string="Over Time", compute='_compute_overtime_hours', store=True, tracking=True)
    ...
    validated_overtime_hours = fields.Float(string="Extra Hours", compute='_compute_validated_overtime_hours', store=True, readonly=True)
