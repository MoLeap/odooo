...
export class HtmlField extends Component {
    ...
    get wysiwygOptions() {
        ...
        return {
            ...
            remapAttachmentsToRecord: this.remapAttachmentsToRecord.bind(this),
        };
    }
    /**
    ...
    async remapAttachmentsToRecord(content, resId, resModel) {
        if (!resId || !content || this.pendingSaveAttachment) {
            return;
        }
        this.pendingSaveAttachment = true;
        ...
        delete this.pendingSaveAttachment;
        return;
    }
