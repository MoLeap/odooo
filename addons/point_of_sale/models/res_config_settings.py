...
class ResConfigSettings(models.TransientModel):
    ...
    show_inventory_settings = fields.Boolean(compute="_compute_show_inventory_settings")
    ...
    def _compute_show_inventory_settings(self):
        for res_config in self:
            res_config.show_inventory_settings = True
