...
class PosOrderLine(models.Model):
    ...
    def _prepare_refund_data(self, refund_order, lots=False):
        """
        ...
        @param lots: the pre-created Pack operation Lot
        @type lots: pos.pack.operation.lot
    ...
    def _compute_total_cost(self, stock_moves=False):
        ...
        for line in self:
            ...
            product_cost = line._get_product_cost(stock_moves)
    ...
    def _get_refund_lines_lots(self):
        return False
