...
class PosPaymentMethod(models.Model):
    ...
    _check_account_bank_statement_id = models.Constraint(
        "CHECK((NOT is_cash_count) OR (account_bank_statement_id IS NOT NULL))",
        'A cash payment method required an outstanding account to be set.',
    )
