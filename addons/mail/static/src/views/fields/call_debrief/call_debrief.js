...
export class CallDebrief extends Component {
    ...
    async _loadData(props) {
        ...
        const optionalFields = await this.orm.call("mail.call.artifact", "fields_get", [
            ["is_stt", "transcript"],
        ]);
    ...
    /**
     * Detects whether the transcript contains timestamps (e.g., VTT/SRT format)
     * or is just plain text.
     * @param {string} transcriptText
     * @returns {"timed" | "plaintext"}
     */
